		...
		<form  method="POST">
			<div class="content">
				...
				<div class="col col-mb-12 col-6">
					...
					<input class="input input-block {if $component.errors.sort_index!}input-error{/if}" type="number" name="sort_index" value="{$component.sort_index}">
				</div>
			</div>
			...
			<textarea class="input input-block" name="description" cols="10">{$component.description}</textarea>
